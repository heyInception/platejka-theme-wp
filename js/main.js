...
const tabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_1__["default"]('spec');
try {
...
let swiperSlider = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](".slider__start", {
...
let swiperClients = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](".slider__clients", {
  modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Pagination],
  pagination: {
    el: '.swiper-pagination'
  },
...
let swiperVslider = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](".v-slider__start", {
  modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Pagination],
  // Navigation arrows
  navigation: {
...
var swiper = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](".compare__slider", {
  modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Thumbs, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Scrollbar],
  spaceBetween: 10,
  slidesPerView: 1,
  watchSlidesProgress: true,
  allowTouchMove: false
});
var swiper2 = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](".compare__thumbs", {
  modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Thumbs, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Scrollbar],
  spaceBetween: 10,
  lidesPerView: 1,
  navigation: {
...
var swiperContacts = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](".mySwiper", {
  modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Thumbs, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Scrollbar],
  loop: true,
  spaceBetween: 8,
  slidesPerView: 5,
...
var swiperContactsTwo = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](".mySwiper2", {
  modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Thumbs, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Scrollbar],
  loop: true,
  spaceBetween: 10,
  navigation: {
    nextEl: ".a-contacts__button_next",
    prevEl: ".a-contacts__button_prev"
  },
  thumbs: {
    swiper: swiperContacts
  }
});

var swiperTeams = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](".a-about__thumbs", {
  modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Thumbs, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Scrollbar],
  loop: true,
  spaceBetween: 8,
  slidesPerView: 5,
  ...
  breakpoints: {
    // when window width is >= 320px
    320: {
      slidesPerView: 2, // Number of columns per view
...
var swiperTeamsTwo = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](".a-about__swiper", {
  modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Thumbs, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Scrollbar],
  loop: true,
  spaceBetween: 10,
  thumbs: {
...
var swiperThumbs = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](".a-stage__thumbs", {
 modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Thumbs, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Scrollbar],
  loop: false,
  spaceBetween: 20,
  slidesPerView: 4.1,
  ...
  watchSlidesProgress: true,
  navigation: {
    nextEl: ".a-stage__button_next",
    prevEl: ".a-stage__button_prev"
  },
  scrollbar: {
    el: '.swiper-scrollbar',
...
var swiperMain = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](".a-stage__swiper", {
  modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Thumbs, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Scrollbar],
  loop: false,
  spaceBetween: 20,
  slidesPerView: 4.1,
...
function syncSliders() {
  const isMobile = window.innerWidth < 1231;

  if (isMobile) {
    // При свайпе миниатюр - переключаем основной слайдер
    swiperThumbs.on('slideChange', function () {
      swiperMain.slideTo(swiperThumbs.activeIndex);
    });

    // При свайпе основного - переключаем миниатюры
    swiperMain.on('slideChange', function () {
      swiperThumbs.slideTo(swiperMain.activeIndex);
    });
  } else {
    // На десктопе используем стандартную синхронизацию через thumbs
    swiperThumbs.off('slideChange');
    swiperMain.off('slideChange');
  }
}
...
jQuery(document).ready(function () {
  if (jQuery(window).width() < 1230) {
    let swiperExhibitions = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](".exhibitions__swiper", {
      modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Thumbs, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Scrollbar],
      centeredSlides: false,
      breakpoints: {
        // when window width is >= 320px
...
jQuery(document).ready(function () {
  function wrapLastSlides() {
    var $slides = jQuery('.exhibitions__swiper .swiper-slide');
    var $wrapper = jQuery('.last-slides-wrapper');

    // Если ширина окна ≥ 1230px
    if (jQuery(window).width() >= 1230) {
      // Если обёртки ещё нет и есть минимум 3 слайда
      if ($wrapper.length === 0 && $slides.length >= 3) {
        var $lastThreeSlides = $slides.slice(-3);
        $lastThreeSlides.wrapAll('<div class="last-slides-wrapper"></div>');
      }
    } else {
      // Если ширина < 1230px - удаляем обёртку
      if ($wrapper.length > 0) {
...
function updateVisibleItems() {
    ...
    itemsToShow = $(window).width() < 1400 ? 4 : 18;
    
    // Скрываем все элементы
    $('.destinations__item').hide();
    
    // Показываем первые `itemsToShow` элементов
    $('.destinations__item').slice(0, itemsToShow).show();
    
    // Проверяем, нужно ли показывать кнопку
    const totalItems = $('.destinations__item').length;
    if (totalItems <= itemsToShow) {
        $('.destinations__btn').hide(); // Скрываем кнопку, если элементов меньше или равно `itemsToShow`
    } else {
        $('.destinations__btn').show(); // Показываем кнопку, если есть скрытые элементы
        $('.destinations__btn').text('Показать все');
    }
}
...
function showItemsWithDelay(startIndex) {
    const items = $('.destinations__item');
    ...
    for (let i = startIndex; i < totalItems; i++) {
        ...
        delay += 90; // Увеличиваем задержку для каждого следующего элемента
    }
}

$('.destinations__btn').click(function () {
    const hiddenItems = $('.destinations__item:gt(' + (itemsToShow - 1) + ')');
    const hiddenCount = hiddenItems.length;

    if (hiddenItems.is(':visible')) {
        // Если скрытые элементы видны, скрываем их
        hiddenItems.fadeOut();
        $(this).text('Показать все');
    } else {
        // Если скрытые элементы не видны, показываем их с задержкой
        $(this).text('Скрыть');
        showItemsWithDelay(itemsToShow);
    }
});

// Обновляем видимость элементов при изменении размера окна
...
//   try {
//   const countries = {
//     'usa': $('.a-service__country-name_usa'),
//     'ger': $('.a-service__country-name_ger'),
//     'tur': $('.a-service__country-name_tur'),
//     'kz': $('.a-service__country-name_kz'),
//     'est': $('.a-service__country-name_est'),
//     'ru': $('.a-service__country-name_ru'),
//     'gk': $('.a-service__country-name_gk'),
//     'vet': $('.a-service__country-name_vet'),
//     'kir': $('.a-service__country-name_kir'),
//     'sing': $('.a-service__country-name_sing'),
//   };

//   // Проверка наличия элемента .a-service__column
//   if ($('.a-service__column').length === 0) {
//     console.warn('Элемент .a-service__column не найден. Скрипт не будет выполнен.');
//     return;
//   }

//   const lines = [];
//   let animated = false;
//   let animationStarted = false; // Флаг для отслеживания, запущена ли уже анимация
...
//       if (animationStarted) return; // Если анимация уже запущена, выходим
      
//       animationStarted = true; // Устанавливаем флаг
//       animated = true;
      
//       // Задержка 2 секунды перед запуском анимации
//       setTimeout(() => {
...
//         // Если элемент вошел в viewport и анимация еще не запускалась
...
//     const targetElement = $('.a-service__column')[0];
//     if (targetElement) {
//       observer.observe(targetElement);
//     }

//     // Очистка observer при размонтировании (если нужно)
//     // observer.disconnect();
//   }
...
(function () {
  ...
  const fixedMenuButton = document?.querySelector('.fixed-menu__button a'); // Добавляем кнопку
  ...
  const toggleMenu = () => {
    ...
    if (menu?.classList.contains('header__wrap_active')) {
  ...
  // Закрытие меню при клике на fixed-menu__button
  fixedMenuButton?.addEventListener('click', () => {
