<?php if (get_field('vklyuchit_blok_spec') == 1) : ?>
  <section class="v-spec">
    <div class="container">
      <div class="v-spec__row">
        <div class="v-spec__title">
        ...
        <div class="tabs v-spec__tabs" data-tabs="spec">
          ...
          <?php if (have_rows('tabs', 24)) : ?>
            <?php while (have_rows('tabs', 24)) : the_row(); ?>
              <div class="tabs__panel">
                ...
                <?php if ($izobrazhenie) : ?>
                  <div class="v-spec__img">
                    <img src="<?php echo esc_url($izobrazhenie['url']); ?>" alt="<?php echo esc_attr($izobrazhenie['alt']); ?>" />
                  </div>
                <?php endif; ?>
                <div class="v-spec__wrap">
                  <div class="v-spec__head"><?php the_sub_field('imya'); ?></div>
                  <?php if (get_sub_field('god')) : ?><div class="v-spec__year"><?php the_sub_field('god'); ?></div><?php endif; ?>
                  <div class="v-spec__text"><?php the_sub_field('tekst'); ?>
                  </div>
                </div>
              </div>
            <?php endwhile; ?>
