...
<article id="post-<?php the_ID(); ?>" class="article__column">
	<div class="article__img">
		...
		if (has_post_thumbnail()) {
			platejka_post_thumbnail(); // функция для вывода миниатюры записи
		} else {?>
			<a href="<?php the_permalink(); ?>"><?php echo '<img src="https://platejka.com/wp-content/uploads/2024/04/default-image-icon-vector-missing-picture-page-website-design-mobile-app-no-photo-available_87543-11093.avif" alt="Placeholder Изображение">'; ?></a>
		<?php
		}
		?>
	</div>
